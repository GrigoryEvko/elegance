...
/// loop per element, so the size of the subset is DATA: the nesting
/// used to be the combinatorics written out, four deep for k=4.
...
/// parameter here travels inside it AND always together, which equal
/// counts is what says.
